        ...
        <div class="header__wrapper">
            ...
            <div class="header__final">
                <div class="header__user header__final-item">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/header/User.png" alt="user" class="header__user-img">
                </div>
                <div class="header__shoping header__final-item">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/header/Shopping-Cart.png" alt="shoping" class="header__shoping-img">
                </div>
